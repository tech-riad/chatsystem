    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">Dashboard /</span> Categories
            </h4>
        ...
        <div class="card mb-4">
            <div class="card-body p-3">
                <form action="{{ route('admin.academy.categories') }}" method="get">
        ...
        <div class="card">
            <div class="table-responsive text-nowrap">
                <table id="categoryTable" class="table table-hover table-striped dt-responsive nowrap" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Name</th>
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.academy.categories.destroy', $category) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<div class="modal fade" id="CategoryAddModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.academy.categories.store') }}" method="post">
                @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        if (document.querySelector('#categoryTable')) {
